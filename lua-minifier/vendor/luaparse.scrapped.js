...
(function (root, name, factory) {
  ...
  var ast = exports.ast = {
    ...
    , continueStatement: function(args) {
      return {
    ...
    , compoundAssignmentStatement: function(expression, operator) {
      return {
  ...
  function lex() {
    ...
    switch (charCode) {
      ...
      case 93: case 40: case 41: case 59: case 38: case 35: case 45:
  ...
  function parseAssignmentOrCallStatement() {
    ...
    if (null == expression) {
      // console.log('exp is null', token, lookahead);
      // if ('+-*/%^'.indexOf(token.value) >= 0 && lookahead.value == '=') {
      //   next();
      //   validateVar(expression);
      //   expect('=');
      //   console.log('ate dat shit up');
      //   parseExpectedExpression();
      //   pushLocation(marker);
      //   return finishNode(ast.compoundAssignmentStatement(expression, token));
      // }
    ...
    //   next();
    //   expect('=');
    //   // console.log(expression, token.value, '+-*/%^='.indexOf(token.value), lookahead.value)
    //   pushLocation(marker);
    //   return finishNode(ast.compoundAssignmentStatement(expression, token));
    // }
  ...
  function parsePrefixExpression() {
    ...
    // } else if (consume('/')) {
    //   console.log(3);
    //   console.log('parsing', token.value, token.type, Identifier);
    //   expect('=');
    //   return null;
      // name = token.value;
      // base = '/';
